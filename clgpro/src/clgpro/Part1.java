...
public class Part1 extends JFrame  {
	...
	public Part1() {
		...
		btnOk.addActionListener(new ActionListener() {
			...
			for(i=0;i<=j;i++){
				if(bn.equals(cse))
			st1.executeUpdate("insert into cse (REGD_NO,NAME,y_join) values ('"+s[i]+"','"+n[i]+"','"+y[i]+"')");
				else if(bn.equals(civ))
					st1.executeUpdate("insert into civ(REGD_NO,NAME,y_join) values ('"+s[i]+"','"+n[i]+"','"+y[i]+"')");
				else if(bn.equals(ele))
					st1.executeUpdate("insert into ele(REGD_NO,NAME,y_join) values ('"+s[i]+"','"+n[i]+"','"+y[i]+"')");
				else if(bn.equals(mec))
					st1.executeUpdate("insert into mec(REGD_NO,NAME,y_join) values ('"+s[i]+"','"+n[i]+"','"+y[i]+"')");
			 ...
			 textField.setText("");
				...
				textField_40.setText("");
					...
					{try{
						st1.close();
					con1.close();}catch(Exception e){System.out.print(e);}
					}				}
