		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(g1.equals(g))
					...
					String mn=textField.getText();
					String nm=String.valueOf(passwordField.getPassword());
					
					rs=st2.executeQuery("select Regd_no from civ where (Regd_no='"+mn+"'&& Password='"+nm+"')");
					String rn="";
					while(rs.next()){
					 rn=rs.getString("Regd_no");}
...
btnNewButton_1.setVisible(false);
					...
					//}catch(Exception e){//System.out.print("siku");System.out.print(e);
					//e.printStackTrace();}
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				catch(Exception e){System.out.println("ss"+e);
				e.printStackTrace();
				}
