			...
			public void keyReleased(KeyEvent arg0) {
				...
				if (s.equals(a)) {
					...
					try {
						...
						rs1 = st1
								.executeQuery("select Book_name,Pub_name from common where Book_name like'" + s + "%'");
		...
		list.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				try {
					...
					String s3 = textField_1.getText();
					if (s3.equals(cse)) {
						rs1 = st1.executeQuery("select Author,Avail_book from cse where Book_name='" + m1
								+ "'&&Pub_name='" + h1 + "'");
					} else if (s3.equals(civ))
						rs1 = st1.executeQuery("select Author,Avail_book from civ where Book_name='" + m1
								+ "'&&Pub_name='" + h1 + "'");
					else if (s3.equals(ele))
						rs1 = st1.executeQuery("select Author,Avail_book from ele where Book_name='" + m1
								+ "'&&Pub_name='" + h1 + "'");
					else if (s3.equals(mec))
						rs1 = st1.executeQuery("select Author,Avail_book from mec where Book_name='" + m1
								+ "'&&Pub_name='" + h1 + "'");
			...
			btnBook.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					try {
						...
						if (p.equals(cse)) {
							rs = st.executeQuery(
									"select BOOK_1NO,BOOK_1NAME,AUTHOR_1,Book_1Idate,BOOK_2NO,BOOK_2NAME,AUTHOR_2,Book_2Idate,BOOK_3NO,BOOK_3NAME,AUTHOR_3,Book_3Idate from cse where REGD_NO='"
											+ textField_2.getText() + "'");
						} else if (p.equals(civ))
							rs = st.executeQuery(
									"select BOOK_1NO,BOOK_1NAME,AUTHOR_1,Book_1Idate,BOOK_2NO,BOOK_2NAME,AUTHOR_2,Book_2Idate,BOOK_3NO,BOOK_3NAME,AUTHOR_3,Book_3Idate from civ where REGD_NO='"
											+ textField_2.getText() + "'");
						else if (p.equals(ele))
							rs = st.executeQuery(
									"select BOOK_1NO,BOOK_1NAME,AUTHOR_1,Book_1Idate,BOOK_2NO,BOOK_2NAME,AUTHOR_2,Book_2Idate,BOOK_3NO,BOOK_3NAME,AUTHOR_3,Book_3Idate from ele where REGD_NO='"
											+ textField_2.getText() + "'");
						else if (p.equals(mec))
							rs = st.executeQuery(
									"select BOOK_1NO,BOOK_1NAME,AUTHOR_1,Book_1Idate,BOOK_2NO,BOOK_2NAME,AUTHOR_2,Book_2Idate,BOOK_3NO,BOOK_3NAME,AUTHOR_3,Book_3Idate from mec where REGD_NO='"
											+ textField_2.getText() + "'");
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				for (int i = 0; i < fi.length(); i++) {
					if (fi.charAt(i) == '-') {
						...
						si = si + String.valueOf(fi.charAt(i));
						f1[ji] = si;
					}
				}
				String sti2 = f1[2] + "-" + f1[1] + "-" + f1[0];
				String ti2=sti2;
				sti2="E:\\project\\Dreport\\"+sti2+".doc";
...
try{
						File file=new File(sti2);
						file.setWritable(true);
						
					PrintWriter pw=new PrintWriter(new FileWriter(file,true));
					
					pw.println("--------------------");
					pw.println("REGD_NO:-"+textField_2.getText());
					pw.println("NAME:-"+textField.getText());
					pw.println("BRANCH:-"+textField_1.getText());
						...
						if (x == 0) {
							if (p4.equals(cse))
								st.executeUpdate("UPDATE  cse SET BOOK_1NO='" + b[0] + "',BOOK_1NAME='" + c[0]
										+ "',AUTHOR_1='" + d[0] + "',Book_1Idate='" + e[0] + "' where REGD_NO='"
										+ textField_2.getText() + "'");
							else if (p4.equals(civ))
								st.executeUpdate("UPDATE  civ SET BOOK_1NO='" + b[0] + "',BOOK_1NAME='" + c[0]
										+ "',AUTHOR_1='" + d[0] + "',Book_1Idate='" + e[0] + "' where REGD_NO='"
										+ textField_2.getText() + "'");
							else if (p4.equals(ele))
								st.executeUpdate("UPDATE ele SET BOOK_1NO='" + b[0] + "',BOOK_1NAME='" + c[0]
										+ "',AUTHOR_1='" + d[0] + "',Book_1Idate='" + e[0] + "' where REGD_NO='"
										+ textField_2.getText() + "'");
							else if (p4.equals(mec))
								st.executeUpdate("UPDATE  mec SET BOOK_1NO='" + b[0] + "',BOOK_1NAME='" + c[0]
										+ "',AUTHOR_1='" + d[0] + "',Book_1Idate='" + e[0] + "' where REGD_NO='"
										+ textField_2.getText() + "'");
							...
							int n1 = 0;
							if (p4.equals(cse)) {
								ResultSet rs = st1.executeQuery("select Avail_book from cse where Book_name='" + m1
										+ "' && Pub_name='" + h1 + "' && Author='" + d[0] + "'");
								while (rs.next())
									n1 = rs.getInt("Avail_book");
								n1 = n1 - 1;
								st1.executeUpdate("Update cse set Avail_book='" + n1 + "' where Book_name='" + m1
										+ "' && Pub_name='" + h1 + "' && Author='" + d[0] + "' ");
							} else if (p4.equals(civ)) {
								ResultSet rs = st1.executeQuery("select Avail_book from civ where Book_name='" + m1
										+ "' && Pub_name='" + h1 + "' && Author='" + d[0] + "'");
								while (rs.next())
									n1 = rs.getInt("Avail_book");
								n1 = n1 - 1;
								st1.executeUpdate("Update civ set Avail_book='" + n1 + "' where Book_name='" + m1
										+ "' && Pub_name='" + h1 + "' && Author='" + d[0] + "' ");
							} else if (p4.equals(ele)) {
								ResultSet rs = st1.executeQuery("select Avail_book from ele where Book_name='" + m1
										+ "' && Pub_name='" + h1 + "' && Author='" + d[0] + "'");
								while (rs.next())
									n1 = rs.getInt("Avail_book");
								n1 = n1 - 1;
								st1.executeUpdate("Update ele set Avail_book='" + n1 + "' where Book_name='" + m1
										+ "' && Pub_name='" + h1 + "' && Author='" + d[0] + "' ");
							} else if (p4.equals(mec)) {
								ResultSet rs = st1.executeQuery("select Avail_book from mec where Book_name='" + m1
										+ "' && Pub_name='" + h1 + "' && Author='" + d[0] + "'");
								while (rs.next())
									n1 = rs.getInt("Avail_book");
								n1 = n1 - 1;
								st1.executeUpdate("Update mec set Avail_book='" + n1 + "' where Book_name='" + m1
										+ "' && Pub_name='" + h1 + "' && Author='" + d[0] + "' ");
							}
							
							pw.println("ACC NO:-"+b[0]);
							pw.println("BOOK NAME:-"+c[0]);
							pw.println("AUTHOR:-"+d[0]);
							pw.println("ISSUE DT:-"+e[0]);
							

						}
						if (y == 0) {
							if (p4.equals(cse))
								st.executeUpdate("UPDATE  cse SET BOOK_2NO='" + b[1] + "',BOOK_2NAME='" + c[1]
										+ "',AUTHOR_2='" + d[1] + "',Book_2Idate='" + e[1] + "' where REGD_NO='"
										+ textField_2.getText() + "'");
							else if (p4.equals(civ))
								st.executeUpdate("UPDATE  civ SET BOOK_2NO='" + b[1] + "',BOOK_2NAME='" + c[1]
										+ "',AUTHOR_2='" + d[1] + "',Book_2Idate='" + e[1] + "' where REGD_NO='"
										+ textField_2.getText() + "'");
							else if (p4.equals(ele))
								st.executeUpdate("UPDATE  ele SET BOOK_2NO='" + b[1] + "',BOOK_2NAME='" + c[1]
										+ "',AUTHOR_2='" + d[1] + "',Book_2Idate='" + e[1] + "' where REGD_NO='"
										+ textField_2.getText() + "'");
							else if (p4.equals(mec))
								st.executeUpdate("UPDATE  mec SET BOOK_2NO='" + b[1] + "',BOOK_2NAME='" + c[1]
										+ "',AUTHOR_2='" + d[1] + "',Book_2Idate='" + e[1] + "' where REGD_NO='"
										+ textField_2.getText() + "'");
							...
							pw.println("ACC NO:-"+b[1]);
							pw.println("BOOK NAME:-"+c[1]);
							pw.println("AUTHOR:-"+d[1]);
							pw.println("ISSUE DT:-"+e[1]);
							

						}
						if (z == 0) {
							if (p4.equals(cse))
								st.executeUpdate("UPDATE  cse SET BOOK_3NO='" + b[2] + "',BOOK_3NAME='" + c[2]
										+ "',AUTHOR_3='" + d[2] + "',Book_3Idate='" + e[2] + "' where REGD_NO='"
										+ textField_2.getText() + "'");
							else if (p4.equals(civ))
								st.executeUpdate("UPDATE  civ SET BOOK_3NO='" + b[2] + "',BOOK_3NAME='" + c[2]
										+ "',AUTHOR_3='" + d[2] + "',Book_3Idate='" + e[2] + "' where REGD_NO='"
										+ textField_2.getText() + "'");
							else if (p4.equals(ele))
								st.executeUpdate("UPDATE  ele SET BOOK_3NO='" + b[2] + "',BOOK_3NAME='" + c[2]
										+ "',AUTHOR_3='" + d[2] + "',Book_3Idate='" + e[2] + "' where REGD_NO='"
										+ textField_2.getText() + "'");
							else if (p4.equals(mec))
								st.executeUpdate("UPDATE  mec SET BOOK_3NO='" + b[2] + "',BOOK_3NAME='" + c[2]
										+ "',AUTHOR_3='" + d[2] + "',Book_3Idate='" + e[2] + "' where REGD_NO='"
										+ textField_2.getText() + "'");
							...
							pw.println("ACC NO:-"+b[2]);
							pw.println("BOOK NAME:-"+c[2]);
							pw.println("AUTHOR:-"+d[2]);
							pw.println("ISSUE DT:-"+e[2]);
					...
					try {
						...
						if (in > 2) {
							...
							if (p4.equals(cse))
								st1.executeUpdate(
										"update cse set No=" + in + " where REGD_NO='" + textField_2.getText() + "'");
							else if (p4.equals(civ))
								st1.executeUpdate(
										"update civ set No=" + in + " where REGD_NO='" + textField_2.getText() + "'");
							else if (p4.equals(mec))
								st1.executeUpdate(
										"update mec set No=" + in + " where REGD_NO='" + textField_2.getText() + "'");
							else if (p4.equals(ele))
								st1.executeUpdate("update ele set No=" + in + " where REGD_NO='" + textField_2.getText() + "'");
		
								if (chckbxNewCheckBox.isSelected() == true) {
									try {
										System.out.println("ACC NO="+textField_3.getText()+"---------"+d);
	Class.forName("com.mysql.jdbc.Driver");
										...
										st1 = con1.createStatement();
										if (p4.equals(cse))
											st1.executeUpdate("UPDATE  cse SET Book_1Idate='" + ti2 + "' where REGD_NO='"
													+ textField_2.getText() + "' ");
										else if (p4.equals(civ))
											st1.executeUpdate("UPDATE  civ SET Book_1Idate='" + ti2 + "' where REGD_NO='"
													+ textField_2.getText() + "' ");
										else if (p4.equals(ele))
											st1.executeUpdate("UPDATE  ele SET Book_1Idate='" + ti2 + "' where REGD_NO='"
													+ textField_2.getText() + "' ");
										else if (p4.equals(mec))
											st1.executeUpdate("UPDATE  mec SET Book_1Idate='" + ti2+ "' where REGD_NO='"
													+ textField_2.getText() + "' ");
										
										pw.println("ACC NO="+textField_3.getText());
										pw.println("BOOK NAME="+textField_6.getText());
										pw.println("BOOK NAME="+textField_9.getText());
										pw.println("RENEW Dt="+ti2);
							...
							if (chckbxNewCheckBox_1.isSelected() == true) {
								try {
									...
									st1 = con1.createStatement();
									if (p4.equals(cse))
										st1.executeUpdate("UPDATE  cse SET Book_2Idate='" + ti2 + "' where REGD_NO='"
												+ textField_2.getText() + "' ");
									else if (p4.equals(civ))
										st1.executeUpdate("UPDATE  civ SET Book_2Idate='" + ti2 + "' where REGD_NO='"
												+ textField_2.getText() + "' ");
									else if (p4.equals(ele))
										st1.executeUpdate("UPDATE  ele SET Book_2Idate='" + ti2 + "' where REGD_NO='"
												+ textField_2.getText() + "' ");
									else if (p4.equals(mec))
										st1.executeUpdate("UPDATE  mec SET Book_2Idate='" + ti2 + "' where REGD_NO='"
												+ textField_2.getText() + "' ");
									pw.println("ACC NO="+textField_4.getText());
									pw.println("BOOK NAME="+textField_7.getText());
									pw.println("BOOK NAME="+textField_10.getText());
									pw.println("RENEW Dt="+ti2);
							...
							if (chckbxNewCheckBox_2.isSelected() == true) {
								try {
									...
									st1 = con1.createStatement();
									if (p4.equals(cse))
										st1.executeUpdate("UPDATE  cse SET Book_3Idate='" + ti2 + "' where REGD_NO='"
												+ textField_2.getText() + "' ");
									else if (p4.equals(civ))
										st1.executeUpdate("UPDATE  civ SET Book_3Idate='" + ti2 + "' where REGD_NO='"
												+ textField_2.getText() + "' ");
									else if (p4.equals(ele))
										st1.executeUpdate("UPDATE  ele SET Book_3Idate='" + ti2 + "' where REGD_NO='"
												+ textField_2.getText() + "' ");
									else if (p4.equals(mec))
										st1.executeUpdate("UPDATE  mec SET Book_3Idate='" + ti2 + "' where REGD_NO='"
												+ textField_2.getText() + "' ");
									pw.println("ACC NO="+textField_5.getText());
									pw.println("BOOK NAME="+textField_8.getText());
									pw.println("BOOK NAME="+textField_11.getText());
									pw.println("RENEW Dt="+ti2);
	} catch (Exception e) {
									JOptionPane.showMessageDialog(null, "NOT UPDATED");
					...
					String a = "0";
					String b = "G:\\New Folder\\" + textField_2.getText() + ".txt";
					...
					file.setWritable(true);
					 ...
					 pw1=new PrintWriter(new FileWriter(file,true));
					pw1.println("--------------------");
					pw1.println("REGD_NO:-"+textField_2.getText());
					pw1.println("NAME:-"+textField.getText());
					pw1.println("BRANCH:-"+textField_1.getText());
					...
					if (chckbxNewCheckBox.isSelected() == true) {
						...
						try {
							...
							LocalDate l2 = LocalDate.of(Integer.valueOf(s2[2]), Integer.valueOf(s2[1]),
							...
							if (p5.equals(cse)) {
								ResultSet rs = st1.executeQuery("select Avail_book from cse where Book_name='" + m1
										+ "' && Pub_name='" + h1 + "' && Author='" + textField_9.getText() + "'");
								while (rs.next())
									n1 = rs.getInt("Avail_book");
								n1 = n1 + 1;
								...
								st1.executeUpdate("Update cse set Avail_book='" + n1 + "' where Book_name='" + m1
										+ "' && Pub_name='" + h1 + "' && Author='" + textField_9.getText() + "' ");
								ResultSet rs2 = st2
										.executeQuery("select fine from cse where REGD_NO='" + textField_2.getText() +"'");
								while (rs2.next())
									f = rs2.getInt("fine");
								f = f + fine;
								
								st2.executeUpdate(
										"Update cse set fine='"+f+"' where REGD_NO='" + textField_2.getText() + "'");
								...
								st1.executeUpdate("Update civ set Avail_book='" + n1 + "' where Book_name='" + m1
										+ "' && Pub_name='" + h1 + "' && Author='" + textField_9.getText() + "' ");
								ResultSet rs2 = st2
										.executeQuery("select fine from civ where REGD_NO='" + textField_2.getText() + "'");
								while (rs2.next())
									f = rs2.getInt("fine");
								f = f + fine;
								st2.executeUpdate(
										"Update civ set fine='"+f+"' where REGD_NO='" + textField_2.getText() + "'");
								...
								st1.executeUpdate("Update ele set Avail_book='" + n1 + "' where Book_name='" + m1
										+ "' && Pub_name='" + h1 + "' && Author='" + textField_9.getText() + "' ");
								ResultSet rs2 = st2
										.executeQuery("select fine from ele where REGD_NO='" + textField_2.getText() + "'");
								while (rs2.next())
									f = rs2.getInt("fine");
								f = f + fine;
								st2.executeUpdate(
										"Update ele set fine='"+f+"' where REGD_NO='" + textField_2.getText() + "'");
								...
								ResultSet rs2 = st2.executeQuery(
										"select fine from mec where REGD_NO='" + textField_2.getText() + "'");
								while (rs2.next())
									f = rs2.getInt("fine");
								f = f + fine;
								System.out.print(f);
								st2.executeUpdate("Update mec set fine='" + f + "' where REGD_NO='"
										+ textField_2.getText() + "'");

							}
							pw1.println("ACC NO="+textField_3.getText());
							pw1.println("BOOK NAME="+textField_6.getText());
							pw1.println("BOOK NAME="+textField_9.getText());
							pw1.println("RETURN Dt="+ti2);
							pw1.println("FINE:-"+f);
						...
						try {
							...
							pw.println(
									textField_3.getText() + "\t" + textField_6.getText() + "\t" + textField_12.getText()
											+ "\t" + textField_16.getText() + "\t" + "RS:" + fine + ".00" + "/-");
							pw.close();
						} catch (Exception e) {
							try {
								File f = new File(b);
								f.createNewFile();
								PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter(b, true)));
								pw.println(textField_3.getText() + "\t" + textField_6.getText() + "\t"
										+ textField_12.getText() + "\t" + textField_16.getText() + "\t" + "RS:" + fine
										+ ".00" + "/-");
								pw.close();
							} catch (Exception e1) {
							}
						...
						try {
							...
							if (p5.equals(cse))
								st.executeUpdate(
										"UPDATE  cse SET BOOK_1NO=0,BOOK_1NAME='',AUTHOR_1='',Book_1Idate='' where REGD_NO='"
												+ textField_2.getText() + "'");
							if (p5.equals(civ))
								st.executeUpdate(
										"UPDATE  civ SET BOOK_1NO=0,BOOK_1NAME='',AUTHOR_1='',Book_1Idate='' where REGD_NO='"
												+ textField_2.getText() + "'");
							if (p5.equals(ele))
								st.executeUpdate(
										"UPDATE  ele SET BOOK_1NO=0,BOOK_1NAME='',AUTHOR_1='',Book_1Idate='' where REGD_NO='"
												+ textField_2.getText() + "'");
							if (p5.equals(mec))
								st.executeUpdate(
										"UPDATE  mec SET BOOK_1NO=0,BOOK_1NAME='',AUTHOR_1='',Book_1Idate='' where REGD_NO='"
												+ textField_2.getText() + "'");
					...
					if (chckbxNewCheckBox_1.isSelected() == true) {
						...
						try {
							...
							Connection con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/book", "root",
									"");
							Connection con2 = DriverManager.getConnection("jdbc:mysql://localhost:3306/clg", "root", "");
							...
							ResultSet rs = null;
							if (p5.equals(cse)) {
								rs = st1.executeQuery("select Avail_book from cse where Book_name='" + m1
										+ "' && Pub_name='" + h1 + "' && Author='" + textField_10.getText() + "'");
								while (rs.next())
									n1 = rs.getInt("Avail_book");
								n1 = n1 + 1;
								System.out.println(n1);
								...
								rs = st1.executeQuery("select Avail_book from civ where Book_name='" + m1
										+ "' && Pub_name='" + h1 + "' && Author='" + textField_10.getText() + "'");
								while (rs.next())
									n1 = rs.getInt("Avail_book");
								n1 = n1 + 1;
								...
								rs = st1.executeQuery("select Avail_book from ele where Book_name='" + m1
										+ "' && Pub_name='" + h1 + "' && Author='" + textField_10.getText() + "'");
								while (rs.next())
									n1 = rs.getInt("Avail_book");
								n1 = n1 + 1;
								...
								rs = st1.executeQuery("select Avail_book from mec where Book_name='" + m1
										+ "' && Pub_name='" + h1 + "' && Author='" + textField_10.getText() + "'");
								while (rs.next())
									n1 = rs.getInt("Avail_book");
								n1 = n1 + 1;
								...
								st1.executeUpdate("Update mec set Avail_book='" + n1 + "' where Book_name='" + m1
										+ "' && Pub_name='" + h1 + "' && Author='" + textField_9.getText() + "' ");
								ResultSet rs2 = st2
										.executeQuery("select fine from mec where REGD_NO='" + textField_2.getText() +"'");
								while (rs2.next())
									f = rs2.getInt("fine");
								f = f + fine;
								
								st2.executeUpdate(
										"Update mec set fine='"+f+"' where REGD_NO='" + textField_2.getText() + "'");
							
							}
							pw1.println("ACC NO="+textField_4.getText());
							pw1.println("BOOK NAME="+textField_7.getText());
							pw1.println("BOOK NAME="+textField_10.getText());
							pw1.println("RETURN Dt="+ti2);
							pw1.println("FINE:-"+f);
						...
						try {
							PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter(b, true)));
							pw.println(
									textField_4.getText() + "\t" + textField_7.getText() + "\t" + textField_13.getText()
											+ "\t" + textField_17.getText() + "\t" + "RS:" + fine + ".00" + "/-");
							pw.close();
						} catch (Exception e) {
							try {
								File f = new File(b);
								f.createNewFile();
								PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter(b, true)));
								pw.println(textField_4.getText() + "\t" + textField_7.getText() + "\t"
										+ textField_13.getText() + "\t" + textField_17.getText() + "\t" + "RS:" + fine
										+ ".00" + "/-");
								pw.close();
							} catch (Exception e1) {
							}
						...
						try {
							...
							if (p5.equals(cse))
								st.executeUpdate(
										"UPDATE  cse SET BOOK_2NO=0,BOOK_2NAME='',AUTHOR_2='',Book_2Idate='' where REGD_NO='"
												+ textField_2.getText() + "'");
							else if (p5.equals(civ))
								st.executeUpdate(
										"UPDATE  civ SET BOOK_2NO=0,BOOK_2NAME='',AUTHOR_2='',Book_2Idate='' where REGD_NO='"
												+ textField_2.getText() + "'");
							else if (p5.equals(ele))
								st.executeUpdate(
										"UPDATE  ele SET BOOK_2NO=0,BOOK_2NAME='',AUTHOR_2='',Book_2Idate='' where REGD_NO='"
												+ textField_2.getText() + "'");
							else if (p5.equals(mec))
								st.executeUpdate(
										"UPDATE  mec SET BOOK_2NO=0,BOOK_2NAME='',AUTHOR_2='',Book_2Idate='' where REGD_NO='"
												+ textField_2.getText() + "'");
					...
					if (chckbxNewCheckBox_2.isSelected() == true) {
						...
						try {
							...
							if (p5.equals(cse)) {
								rs = st1.executeQuery("select Avail_book from cse where Book_name='" + m1
										+ "' && Pub_name='" + h1 + "' && Author='" + textField_11.getText() + "'");
								while (rs.next())
									n1 = rs.getInt("Avail_book");
								n1 = n1 + 1;
								st1.executeUpdate("Update cse set Avail_book='" + n1 + "' where Book_name='" + m1
							...
							pw1.println("ACC NO="+textField_5.getText());
							pw1.println("BOOK NAME="+textField_8.getText());
							pw1.println("BOOK NAME="+textField_11.getText());
							pw1.println("RETURN Dt="+ti2);
							pw1.println("FINE:-"+f);
						...
						try {
							PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter(b, true)));
							pw.println(
									textField_5.getText() + "\t" + textField_8.getText() + "\t" + textField_14.getText()
											+ "\t" + textField_18.getText() + "\t" + "RS:" + fine + ".00" + "/-");
							pw.close();
						} catch (Exception e) {
							try {
								File f = new File(b);
								f.createNewFile();
								PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter(b, true)));
								pw.println(textField_5.getText() + "\t" + textField_8.getText() + "\t"
										+ textField_14.getText() + "\t" + textField_18.getText() + "\t" + "RS:" + fine
										+ ".00" + "/-");
								pw.close();
							} catch (Exception e1) {
							}
						...
						try {
							...
							if (p5.equals(cse))
								st.executeUpdate(
										"UPDATE  cse SET BOOK_3NO=0,BOOK_3NAME='',AUTHOR_3='',Book_3Idate='' where REGD_NO='"
												+ textField_2.getText() + "'");
							else if (p5.equals(civ))
								st.executeUpdate(
										"UPDATE  civ SET BOOK_3NO=0,BOOK_3NAME='',AUTHOR_3='',Book_3Idate='' where REGD_NO='"
												+ textField_2.getText() + "'");
							else if (p5.equals(ele))
								st.executeUpdate(
										"UPDATE  ele SET BOOK_3NO=0,BOOK_3NAME='',AUTHOR_3='',Book_3Idate='' where REGD_NO='"
												+ textField_2.getText() + "'");
							else if (p5.equals(mec))
								st.executeUpdate(
										"UPDATE  mec SET BOOK_3NO=0,BOOK_3NAME='',AUTHOR_3='',Book_3Idate='' where REGD_NO='"
												+ textField_2.getText() + "'");
		...
		btnOk_1.setBounds(829, 393, 89, 23);
