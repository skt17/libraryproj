			...
			try{
			 ...
			 else
			 {
				...
				String s4="";
				 ...
				 if(b1.equals(cse))
			 rs=st.executeQuery("select NAME,BOOK_1NO,BOOK_1NAME,AUTHOR_1,Book_1Idate,BOOK_2NO,BOOK_2NAME,AUTHOR_2,Book_2Idate,BOOK_3NO,BOOK_3NAME,AUTHOR_3,Book_3Idate from cse where REGD_NO='"+n+"'");
			 else if(b1.equals(civ))
				 rs=st.executeQuery("select NAME,BOOK_1NO,BOOK_1NAME,AUTHOR_1,Book_1Idate,BOOK_2NO,BOOK_2NAME,AUTHOR_2,Book_2Idate,BOOK_3NO,BOOK_3NAME,AUTHOR_3,Book_3Idate from civ where REGD_NO='"+n+"'");
			 else if(b1.equals(ele))
				 rs=st.executeQuery("select NAME,BOOK_1NO,BOOK_1NAME,AUTHOR_1,Book_1Idate,BOOK_2NO,BOOK_2NAME,AUTHOR_2,Book_2Idate,BOOK_3NO,BOOK_3NAME,AUTHOR_3,Book_3Idate from ele where REGD_NO='"+n+"'");
			 else if(b1.equals(mec))
				 rs=st.executeQuery("select NAME,BOOK_1NO,BOOK_1NAME,AUTHOR_1,Book_1Idate,BOOK_2NO,BOOK_2NAME,AUTHOR_2,Book_2Idate,BOOK_3NO,BOOK_3NAME,AUTHOR_3,Book_3Idate from mec where REGD_NO='"+n+"'");
...
try{
		  ...
		  st=con.createStatement();
		  if(bn.equals("cse"))
		  st.executeUpdate("insert into cse(Regd_no,Password,Hint) values('"+rn+"','"+p+"','"+hn+"')");
		  else if(bn.equals("civ"))
			  st.executeUpdate("insert into civ(Regd_no,Password,Hint) values('"+rn+"','"+p+"','"+hn+"')");
		  else if(bn.equals("mec"))
			  st.executeUpdate("insert into mec(Regd_no,Password,Hint) values('"+rn+"','"+p+"','"+hn+"')");
		  else if(bn.equals("ele"))
			  st.executeUpdate("insert into ele(Regd_no,Password,Hint) values('"+rn+"','"+p+"','"+hn+"')");
	dout.writeUTF("1");	 
	...
	dout.writeUTF("0");	 
			...
			catch(Exception e){System.out.println("111"+e);
