...
public class cld {
	...
	private void initialize() {
		...
		btnNewButton_4.setBounds(578, 125, 230, 23);
...
rno=k;
						...
						Part.lblNewLabel.setVerticalAlignment(SwingConstants.TOP);
						try {
							String pn = "E:\\" + k + ".jpg";
							Part.lblNewLabel.setIcon(new ImageIcon(
									new ImageIcon(pn).getImage().getScaledInstance(80, 80, Image.SCALE_DEFAULT)));
						} catch (Exception e) {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				txt.setVisible(false);
				scrollPane.setVisible(false);
new demoxl0().setVisible(true);;
				/*Part2 p2 = new Part2();
				p2.setVisible(true);*/

			}
		});
		btnNewButton_1.setBounds(588, 159, 212, 23);
		...
		btnNewButton_2.setBounds(561, 92, 254, 23);
		...
		JButton btnNewButton_5 = new JButton("Write Message\r\n");
		btnNewButton_5.setVisible(false);
		btnNewButton_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				new dismessage().setVisible(true);
			}
		});
		btnNewButton_5.setBounds(606, 193, 202, 23);
		frame.getContentPane().add(btnNewButton_5);
		
		JButton btnNewButton_6 = new JButton("Delete Previous Message");
		...
		btnNewButton_6.setBounds(606, 224, 194, 23);
		frame.getContentPane().add(btnNewButton_6);
		
		JButton btnNewButton_7 = new JButton("Daily Report");
		...
		btnNewButton_7.setBounds(578, 258, 229, 23);
		...
		btnAdminstrator.setBounds(582, 290, 114, 23);
